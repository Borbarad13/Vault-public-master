	...
	public void addInformation(World world, List<ITextComponent> tooltip, ITooltipFlag flag) {
		for(Modifier modifier: this.modifiers) {
			StringTextComponent name = new StringTextComponent(modifier.name);
				tooltip.add(new StringTextComponent("- Has the ")
				.append(new StringTextComponent(modifier.name).setStyle(Style.EMPTY.setColor(Color.fromInt(ModConfigs.VAULT_MODIFIERS.getByName(modifier.name).getColor()))))
