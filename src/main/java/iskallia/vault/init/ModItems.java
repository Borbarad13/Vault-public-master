...
public class ModItems {
    ...
    public static BasicItem VAULT_INGOT_PLATE = new BasicItem(Vault.id("vault_ingot_plate"), new Item.Properties().group(VAULT_MOD_GROUP));
    public static BasicItem VAULT_ESSENCE = new BasicItem(Vault.id("vault_essence"), new Item.Properties().group(VAULT_MOD_GROUP));
    public static BasicItem VAULT_ESSENCE_SHEET = new BasicItem(Vault.id("vault_essence_sheet"), new Item.Properties().group(VAULT_MOD_GROUP));


    public static BasicItem UNSTABLE_VOID_CORE = new BasicItem(Vault.id("unstable_void_core"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(1));
    public static BasicItem CRYSTAL_ENGRAVER = new BasicItem(Vault.id("crystal_engraver"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(1));
    public static BasicItem CLEANSING_CLOTH = new BasicItem(Vault.id("cleansing_cloth"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(1));
    public static ItemVaultGem MISCELANEYOUS_GEM = new ItemVaultGem(VAULT_MOD_GROUP, Vault.id("gem_miscelaneyous"));
    public static ItemVaultGem DOGECOIN_GEM = new ItemVaultGem(VAULT_MOD_GROUP, Vault.id("gem_dogecoin"));
    public static ItemVaultGem JOOLSPER_GEM = new ItemVaultGem(VAULT_MOD_GROUP, Vault.id("gem_joolsper"));
    public static ItemVaultGem POP_RAWK_GEM = new ItemVaultGem(VAULT_MOD_GROUP, Vault.id("gem_pop_rawk"));
    public static ItemVaultGem EGGATE_GEM = new ItemVaultGem(VAULT_MOD_GROUP, Vault.id("gem_eggate"));
    public static ItemVaultGem LABRAJOERITE_GEM = new ItemVaultGem(VAULT_MOD_GROUP, Vault.id("gem_labrajoerite"));

    public static ItemVoidCore VOID_CORE = new ItemVoidCore(VAULT_MOD_GROUP, Vault.id("void_core"));
    //public static ItemVoidCore VOID_CORE = new ItemVoidCore(Vault.id("void_core"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    ...
    public static ItemVaultKey JOOLSPER_KEY = new ItemVaultKey(VAULT_MOD_GROUP, Vault.id("key_joolsper"));
    public static ItemVaultKey MISCELANEYOUS_KEY = new ItemVaultKey(VAULT_MOD_GROUP, Vault.id("key_miscelaneyous"));
    public static ItemVaultKey POP_RAWK_KEY = new ItemVaultKey(VAULT_MOD_GROUP, Vault.id("key_pop_rawk"));
    public static ItemVaultKey EGGATE_KEY = new ItemVaultKey(VAULT_MOD_GROUP, Vault.id("key_eggate"));
    public static ItemVaultKey LABRAJOERITE_KEY = new ItemVaultKey(VAULT_MOD_GROUP, Vault.id("key_labrajoerite"));
    ...
    public static ItemTraderCore TRADER_CORE_BLACK_MARKET = new ItemTraderCore(VAULT_MOD_GROUP, Vault.id("trader_core_black_market"));
    ...
    public static BasicItem ROUGH_ALEXANDRITE = new BasicItem(Vault.id("rough_alexandrite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_BENITOITE = new BasicItem(Vault.id("rough_benitoite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_LARIMAR = new BasicItem(Vault.id("rough_larimar"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_BLACK_OPAL = new BasicItem(Vault.id("rough_black_opal"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_PAINITE = new BasicItem(Vault.id("rough_painite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_ISKALLIUM = new BasicItem(Vault.id("rough_iskallium"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_RENIUM = new BasicItem(Vault.id("rough_renium"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_GORGINITE = new BasicItem(Vault.id("rough_gorginite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_SPARKLETINE = new BasicItem(Vault.id("rough_sparkletine"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_WUTODIE = new BasicItem(Vault.id("rough_wutodie"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_JOOLSPER = new BasicItem(Vault.id("rough_joolsper"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_MISCELANEYOUS = new BasicItem(Vault.id("rough_miscelaneyous"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_POP_RAWK = new BasicItem(Vault.id("rough_pop_rawk"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_EGGATE = new BasicItem(Vault.id("rough_eggate"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem ROUGH_LABRAJOERITE = new BasicItem(Vault.id("rough_labrajoerite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));

    
    public static BasicItem POLISHED_ALEXANDRITE = new BasicItem(Vault.id("polished_alexandrite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_BENITOITE = new BasicItem(Vault.id("polished_benitoite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_LARIMAR = new BasicItem(Vault.id("polished_larimar"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_BLACK_OPAL = new BasicItem(Vault.id("polished_black_opal"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_PAINITE = new BasicItem(Vault.id("polished_painite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_ISKALLIUM = new BasicItem(Vault.id("polished_iskallium"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_RENIUM = new BasicItem(Vault.id("polished_renium"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_GORGINITE = new BasicItem(Vault.id("polished_gorginite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_SPARKLETINE = new BasicItem(Vault.id("polished_sparkletine"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_WUTODIE = new BasicItem(Vault.id("polished_wutodie"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_JOOLSPER = new BasicItem(Vault.id("polished_joolsper"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_MISCELANEYOUS = new BasicItem(Vault.id("polished_miscelaneyous"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_POP_RAWK = new BasicItem(Vault.id("polished_pop_rawk"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_EGGATE = new BasicItem(Vault.id("polished_eggate"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem POLISHED_LABRAJOERITE = new BasicItem(Vault.id("polished_labrajoerite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    

    public static BasicItem CHUNK_JOOLSPER = new BasicItem(Vault.id("chunk_joolsper"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem CHUNK_MISCELANEYOUS = new BasicItem(Vault.id("chunk_miscelaneyous"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem CHUNK_POP_RAWK = new BasicItem(Vault.id("chunk_pop_rawk"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem CHUNK_EGGATE = new BasicItem(Vault.id("chunk_eggate"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem CHUNK_LABRAJOERITE = new BasicItem(Vault.id("chunk_labrajoerite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));

    public static BasicItem CLUSTER_JOOLSPER = new BasicItem(Vault.id("cluster_joolsper"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem CLUSTER_MISCELANEYOUS = new BasicItem(Vault.id("cluster_miscelaneyous"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem CLUSTER_POP_RAWK = new BasicItem(Vault.id("cluster_pop_rawk"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem CLUSTER_EGGATE = new BasicItem(Vault.id("cluster_eggate"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    public static BasicItem CLUSTER_LABRAJOERITE = new BasicItem(Vault.id("cluster_labrajoerite"), new Item.Properties().group(VAULT_MOD_GROUP).maxStackSize(64));
    ...
    public static BasicItem VAULT_BRONZE = new BasicItem(Vault.id("vault_bronze"), new Item.Properties().group(VAULT_MOD_GROUP));
    public static BasicItem VAULT_SILVER = new BasicItem(Vault.id("vault_silver"), new Item.Properties().group(VAULT_MOD_GROUP)); 
    ...
    public static LootableItem GEAR_BAG = new LootableItem(Vault.id("gear_bag"), new Item.Properties().group(VAULT_MOD_GROUP), () -> ModConfigs.GEAR_BAG.POOL.getRandom(new Random()).toStack());
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        registry.register(CLEANSING_CLOTH);
        registry.register(CRYSTAL_ENGRAVER);
        registry.register(UNSTABLE_VOID_CORE);
        registry.register(MISCELANEYOUS_GEM);
        registry.register(DOGECOIN_GEM);
        registry.register(JOOLSPER_GEM);
        registry.register(POP_RAWK_GEM);
        registry.register(EGGATE_GEM);
        registry.register(LABRAJOERITE_GEM);

        registry.register(POLISHED_ALEXANDRITE);
        registry.register(POLISHED_BENITOITE);
        registry.register(POLISHED_LARIMAR);
        registry.register(POLISHED_BLACK_OPAL);
        registry.register(POLISHED_PAINITE);
        registry.register(POLISHED_ISKALLIUM);
        registry.register(POLISHED_RENIUM);
        registry.register(POLISHED_GORGINITE);
        registry.register(POLISHED_SPARKLETINE);
        registry.register(POLISHED_WUTODIE);
        registry.register(POLISHED_JOOLSPER);
        registry.register(POLISHED_MISCELANEYOUS);
        registry.register(POLISHED_POP_RAWK);
        registry.register(POLISHED_EGGATE);
        registry.register(POLISHED_LABRAJOERITE);

        registry.register(ROUGH_ALEXANDRITE);
        registry.register(ROUGH_BENITOITE);
        registry.register(ROUGH_LARIMAR);
        registry.register(ROUGH_BLACK_OPAL);
        registry.register(ROUGH_PAINITE);
        registry.register(ROUGH_ISKALLIUM);
        registry.register(ROUGH_RENIUM);
        registry.register(ROUGH_GORGINITE);
        registry.register(ROUGH_SPARKLETINE);
        registry.register(ROUGH_WUTODIE);
        registry.register(ROUGH_JOOLSPER);
        registry.register(ROUGH_MISCELANEYOUS);
        registry.register(ROUGH_POP_RAWK);
        registry.register(ROUGH_EGGATE);
        registry.register(ROUGH_LABRAJOERITE);


        registry.register(CLUSTER_JOOLSPER);
        registry.register(CLUSTER_MISCELANEYOUS);
        registry.register(CLUSTER_POP_RAWK);
        registry.register(CLUSTER_EGGATE);
        registry.register(CLUSTER_LABRAJOERITE);

        registry.register(CHUNK_JOOLSPER);
        registry.register(CHUNK_MISCELANEYOUS);
        registry.register(CHUNK_POP_RAWK);
        registry.register(CHUNK_EGGATE);
        registry.register(CHUNK_LABRAJOERITE);
        ...
        registry.register(MISCELANEYOUS_KEY);
        registry.register(JOOLSPER_KEY);
        registry.register(POP_RAWK_KEY);
        registry.register(EGGATE_KEY);
        registry.register(LABRAJOERITE_KEY);
        ...
        registry.register(TRADER_CORE_BLACK_MARKET);
        ...
        registry.register(VAULT_INGOT_PLATE);
        registry.register(VAULT_ESSENCE);
        registry.register(VAULT_ESSENCE_SHEET);
        registry.register(MYSTERY_BOX);
        registry.register(GEAR_BAG);
