...
public class ModBlocks {
    ...
    public static final OreBlock RANDOMITE_ORE = new VaultOreBlock();
    public static final OreBlock MISCELANEYOUS_ORE = new VaultOreBlock();
    public static final OreBlock DOGETINE_ORE = new VaultOreBlock();
    public static final OreBlock JOOLSPER_ORE = new VaultOreBlock();
    public static final OreBlock POP_RAWK_ORE = new VaultOreBlock();
    public static final OreBlock EGGATE_ORE = new VaultOreBlock();
    public static final OreBlock LABRAJOERITE_ORE = new VaultOreBlock();
    ...
    public static final DoorBlock JOOLSPER_DOOR = new VaultDoorBlock(ModItems.JOOLSPER_KEY);
    public static final DoorBlock MISCELANEYOUS_DOOR = new VaultDoorBlock(ModItems.MISCELANEYOUS_KEY);
    public static final DoorBlock POP_RAWK_DOOR = new VaultDoorBlock(ModItems.POP_RAWK_KEY);
    public static final DoorBlock EGGATE_DOOR = new VaultDoorBlock(ModItems.EGGATE_KEY);
    public static final DoorBlock LABRAJOERITE_DOOR = new VaultDoorBlock(ModItems.LABRAJOERITE_KEY);
    ...
    public static final TransmogBlock TRANSMOG = new TransmogBlock();
    public static final Block VAULT_DIAMOND_BLOCK = new Block(AbstractBlock.Properties.from(Blocks.DIAMOND_BLOCK));
    public static final Block VAULT_ESSENCE_BLOCK = new Block(AbstractBlock.Properties.from(Blocks.DIAMOND_BLOCK));
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        ...
        registerBlock(event, TRANSMOG, Vault.id("transmog"));

        registerBlock(event, RANDOMITE_ORE, Vault.id("ore_randomite"));
        registerBlock(event, DOGETINE_ORE, Vault.id("ore_dogetine"));
        registerBlock(event, MISCELANEYOUS_ORE, Vault.id("ore_miscelaneyous"));
        registerBlock(event, JOOLSPER_ORE, Vault.id("ore_joolsper"));
        registerBlock(event, POP_RAWK_ORE, Vault.id("ore_pop_rawk"));
        registerBlock(event, EGGATE_ORE, Vault.id("ore_eggate"));
        registerBlock(event, LABRAJOERITE_ORE, Vault.id("ore_labrajoerite"));
        ...
        registerBlock(event, JOOLSPER_DOOR, Vault.id("door_joolsper"));
        registerBlock(event, MISCELANEYOUS_DOOR, Vault.id("door_miscelaneyous"));
        registerBlock(event, POP_RAWK_DOOR, Vault.id("door_pop_rawk"));
        registerBlock(event, EGGATE_DOOR, Vault.id("door_eggate"));
        registerBlock(event, LABRAJOERITE_DOOR, Vault.id("door_labrajoerite"));
        ...
        registerBlock(event, VAULT_ESSENCE_BLOCK, Vault.id("vault_essence_block"));
    ...
    public static void registerBlockItems(RegistryEvent.Register<Item> event) {
        ...
        registerBlockItem(event, TRANSMOG);

        registerBlockItem(event, RANDOMITE_ORE);
        registerBlockItem(event, MISCELANEYOUS_ORE);
        registerBlockItem(event, DOGETINE_ORE);
        registerBlockItem(event, JOOLSPER_ORE);
        registerBlockItem(event, POP_RAWK_ORE);
        registerBlockItem(event, EGGATE_ORE);
        registerBlockItem(event, LABRAJOERITE_ORE);
        ...
        registerTallBlockItem(event, JOOLSPER_DOOR);
        registerTallBlockItem(event, MISCELANEYOUS_DOOR);
        registerTallBlockItem(event, POP_RAWK_DOOR);
        registerTallBlockItem(event, EGGATE_DOOR);
        registerTallBlockItem(event, LABRAJOERITE_DOOR);
        ...
        registerBlockItem(event, VAULT_ESSENCE_BLOCK);
