...
public class ModContainers {
    ...
    public static ContainerType<TransmogContainer> TRANSMOG_CONTAINER;
    ...
    public static void register(RegistryEvent.Register<ContainerType<?>> event) {
        ...
        TRANSMOG_CONTAINER = createContainerType((windowId, inventory, buffer) -> {
            PlayerEntity player = inventory.player;
        ...
        event.getRegistry().registerAll(
                ...
                TRANSMOG_CONTAINER.setRegistryName("transmog_container"),
