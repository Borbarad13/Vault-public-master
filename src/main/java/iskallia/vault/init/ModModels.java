...
public class ModModels {
    ...
    public static void setupRenderLayers() {
        ...
        RenderTypeLookup.setRenderLayer(ModBlocks.MISCELANEYOUS_DOOR, RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.JOOLSPER_DOOR, RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.POP_RAWK_DOOR, RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.EGGATE_DOOR, RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.LABRAJOERITE_DOOR, RenderType.getCutout());
...
//        RenderTypeLookup.setRenderLayer(ModBlocks.CRYO_CHAMBER, CustomRenderType.INSTANCE);
        ...
        RenderTypeLookup.setRenderLayer(ModBlocks.TRANSMOG, RenderType.getCutout());
    }
    ...
    public static class GearModel {
        ...
        public static GearModel ELF;
        public static GearModel DARK;
        public static GearModel LIGHT;
        public static GearModel ORC;
        public static GearModel GUNDAM;
        public static GearModel EGG;
        public static GearModel DRUID;
        ...
        public static void register() {
            ...
            ELF = register("Elf", ElfArmorModel.class);                         //13
            DARK = register("Dark", DarkArmorModel.class);                      //14
            LIGHT = register("Light", LightArmorModel.class);                   //15
            ORC = register("Orc", OrcArmorModel.class);                         //16
            GUNDAM = register("Gundam", GundamArmorModel.class);                //17
            EGG = register("Egg", EggArmorModel.class);                         //18
            DRUID = register("Druid", DruidArmorModel.class);                   //19
        }
        ...
        public String getTextureName(EquipmentSlotType slotType, String type, Integer modelId) {
            String base = Vault.sId("textures/models/armor/" + this.displayName.toLowerCase().replace(" ", "_") + "_armor")
                    + ((slotType == EquipmentSlotType.LEGS && modelId < 12) ? "_layer2" : "_layer1");
            return (type == null ? base : base + "_" + type) + ".png";
        }

        public String getTextureNameNew(String type) {
            String base = Vault.sId("textures/models/armor/" + this.displayName.toLowerCase().replace(" ", "_"));
            return (type == null ? base : base + "_" + type) + ".png";
        }
        ...
        private static <T extends VaultGearModel<? extends LivingEntity>> GearModel register(String textureName, Class<T> modelClass) {
            try {
                ...
                if (modelClass != null) {
                    ...
                    GearModel.REGISTRY.put(GearModel.REGISTRY.size(), gearModel);
                }
                return gearModel;
            }
            catch (Exception e) {
