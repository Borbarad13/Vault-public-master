...
public class ModRecipes
{
	...
	public static final IRecipeType<TransmogRecipe> TRANSMOG_RECIPE = new IRecipeType<TransmogRecipe>()
	{
		@Override
		public String toString()
		{
			return Vault.id("transmog_recipe").toString();
		}
	};
	...
	public static void registerRecipes(RegistryEvent.Register<IRecipeSerializer<?>> event)
	{
		...
		Registry.register(Registry.RECIPE_TYPE, new ResourceLocation(TRANSMOG_RECIPE.toString()), TRANSMOG_RECIPE);
		event.getRegistry().register(TransmogRecipe.SERIALIZER);
	}
