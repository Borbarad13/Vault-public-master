...
public class VaultAltarTileEntity extends TileEntity implements ITickableTileEntity {
    ...
    private void completeInfusion(World world) {
        ...
        this.infusing = false;
        ServerPlayerEntity player = world.getServer().getPlayerList().getPlayerByUUID(this.owner);
        ...
        VaultRarity rarity = VaultRarity.getWeightedRandom();
        ItemStack crystal = ItemVaultCrystal.getCrystalModified(rarity, world.getRandom(), stats.getVaultLevel());
