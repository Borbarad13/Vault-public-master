...
public class VendingMachineBlock extends Block {
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit) {
        ...
        if (heldStack.getItem() instanceof ItemTraderCore) {
            ...
            if( !(heldStack.getOrCreateTag().contains("core", Constants.NBT.TAG_COMPOUND)) ) return ActionResultType.FAIL;
            if(coreToInsert == null || coreToInsert.getTrade() == null || !(heldStack.getOrCreateTag().contains("core", Constants.NBT.TAG_COMPOUND)) ) return ActionResultType.FAIL;
