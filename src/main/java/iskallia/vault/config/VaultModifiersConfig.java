...
public class VaultModifiersConfig extends Config {
	...
	protected void reset() {
		...
		this.EFFECT_MODIFIERS = Arrays.asList(
				new EffectModifier("Treasure", Vault.id("textures/gui/modifiers/treasure.png"), Effects.LUCK, 2, "ADD", EffectAbility.Type.ICON_ONLY),
				new EffectModifier("Hoarder", Vault.id("textures/gui/modifiers/treasure.png"), Effects.LUCK, 1, "ADD", EffectAbility.Type.ICON_ONLY),
